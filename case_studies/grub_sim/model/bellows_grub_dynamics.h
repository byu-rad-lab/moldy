...
Eigen::MatrixXd calc_state_derivs(const Eigen::MatrixXd &X, const Eigen::MatrixXd &U, double m, double stiffness, double damping, double alpha, double h, double r);
